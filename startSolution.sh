#!/usr/bin/env bash
ps aux  |  grep -i com.wso2.finance.open.banking.conformance.api |  awk '{print $2}'  |  xargs kill -9
...
nohup java -jar components/com.wso2.finance.open.banking.conformance.api/target/com.wso2.finance.open.banking.conformance.api-1.0.0-SNAPSHOT-jar-with-dependencies.jar >/dev/null 2>&1 &
