...
public class RequestGenerator {
    ...
    public RequestSpecification createRequest(String endPoint) {
        ...
        RestAssured.baseURI = Context.getInstance()
    ...
    public RequestSpecification createRequestForTokenEndPoint(String endPoint) {
        ...
        //client_id=MGw0ych4DOR9Fz_m6xwEWLdIMjQa&grant_type=authorization_code
        // &code=4bf4c166-32ab-373a-ae11-38ff438806af&scope=accounts payments
        // &redirect_uri=https://openbanking.wso2.com/authenticationendpoint/authorize_callback.do"
        ...
        // -d "client_id=MGw0ych4DOR9Fz_m6xwEWLdIMjQa&grant_type=authorization_code
        // &code=4bf4c166-32ab-373a-ae11-38ff438806af&scope=accounts payments
        // &redirect_uri=https://openbanking.wso2.com/authenticationendpoint/authorize_callback.do"
        ...
        String swaggerJsonFile = Context.getInstance().getSwaggerJsonFile(Constants.TOKEN_API_SPEC + "v1.0.0");
        SwaggerValidationFilter validationFilter = new SwaggerValidationFilter(swaggerJsonFile);
